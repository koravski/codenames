...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <Link href="/">
        <h1 className="h1 font-mono mt-6 cursor-pointer">Codegames</h1>
      </Link>
      ...
      <div className="text-sm">
        ...
        <p>
          ...
          collected and recorded by codenames and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in codenames. This policy is not
        ...
        <p>
          codenames follows a standard procedure of using log files. These
        ...
        <p>
          Like any other website, codenames uses 'cookies'. These cookies
        ...
        <p>
          codenames's Privacy Policy does not apply to other advertisers
        ...
        <p>
          codenames does not knowingly collect any Personal Identifiable
